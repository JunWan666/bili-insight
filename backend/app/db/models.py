...
class AppUser(Base):
    """Single local administrator used to protect the application surface."""
...
class MediaStream(Base):
    ...
    codec_string: Mapped[str | None] = mapped_column(String(128))
    init_range_start: Mapped[int | None] = mapped_column(BigInteger)
    init_range_end: Mapped[int | None] = mapped_column(BigInteger)
    index_range_start: Mapped[int | None] = mapped_column(BigInteger)
    index_range_end: Mapped[int | None] = mapped_column(BigInteger)
