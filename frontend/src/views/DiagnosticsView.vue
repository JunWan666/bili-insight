...
<style scoped>
.diagnostics-view { width: 100%; }.overview { display: grid; grid-template-columns: auto 1fr auto; align-items: center; gap: 16px; padding: 18px; }.app-mark { display: grid; place-items: center; width: 55px; height: 55px; border-radius: 17px; background: var(--brand); color: white; box-shadow: 0 10px 22px rgba(70, 90, 203, .24); }.app-mark svg { width: 27px; }.overview p, .overview h2, .overview span { margin: 0; }.overview p { color: var(--brand); font-size: 9px; font-weight: 800; letter-spacing: 0; }.overview h2 { margin: 4px 0; font-size: 19px; }.overview > div > span { color: var(--text-tertiary); font-size: 11px; }.overview dl { grid-column: 2 / -1; display: grid; grid-template-columns: repeat(3, 1fr); gap: 16px; margin: 3px 0 0; padding-top: 14px; border-top: 1px solid var(--line-soft); }.overview dt { color: var(--text-tertiary); font-size: 9px; }.overview dd { margin: 4px 0 0; color: var(--text-secondary); font-size: 11px; overflow-wrap: anywhere; }
.health-section { margin-top: 18px; }.section-heading h2 { margin: 0; font-size: 19px; }.section-heading p { margin: 4px 0 11px; color: var(--text-secondary); }.component-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 9px; }.component-grid article { display: grid; grid-template-columns: auto 1fr auto; align-items: start; gap: 10px; padding: 13px; }.component-icon { display: grid; place-items: center; width: 37px; height: 37px; border-radius: 11px; background: var(--surface-muted); color: var(--brand); }.component-icon .el-icon { font-size: 19px; }.component-grid h3, .component-grid p { margin: 0; }.component-grid h3 { font-size: 13px; }.component-grid p { margin-top: 3px; color: var(--text-secondary); font-size: 10px; line-height: 1.45; }.component-grid small { display: block; margin-top: 4px; color: var(--text-tertiary); font-size: 9px; }
.metrics-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 10px; margin-top: 16px; }.metrics-grid > article { padding: 16px; }.metric-title { display: flex; align-items: center; gap: 10px; }.metric-title > span { display: grid; place-items: center; width: 38px; height: 38px; border-radius: 10px; background: var(--brand-soft); color: var(--brand); }.metric-title svg { width: 19px; }.metric-title h2, .metric-title p { margin: 0; }.metric-title h2 { font-size: 15px; }.metric-title p { margin-top: 3px; color: var(--text-tertiary); font-size: 10px; }.disk-values { margin: 14px 0 8px; }.disk-values strong { font-size: 26px; }.disk-values span { color: var(--text-tertiary); }.metrics-grid dl { display: flex; gap: 30px; margin: 11px 0 0; }.metrics-grid dt { color: var(--text-tertiary); font-size: 9px; }.metrics-grid dd { margin: 3px 0 0; font-size: 11px; }.queue-grid { display: grid; grid-template-columns: repeat(3, 1fr); gap: 8px; margin-top: 14px; }.queue-grid div { padding: 10px; border-radius: 11px; background: var(--surface-muted); }.queue-grid strong, .queue-grid small { display: block; }.queue-grid strong { font-size: 21px; }.queue-grid small { color: var(--text-tertiary); font-size: 9px; }.queue-grid .danger strong { color: var(--danger); }.metric-link { display: flex; align-items: center; gap: 6px; margin-top: 11px; font-size: 11px; font-weight: 650; text-decoration: none; }.metric-link .el-icon { transform: rotate(180deg); }
.diagnostics-footer { display: grid; grid-template-columns: 1fr 1fr; gap: 10px; margin-top: 10px; }.diagnostic-privacy { display: flex; align-items: flex-start; gap: 12px; padding: 15px; background: var(--brand-soft); color: var(--brand); }.diagnostic-privacy > .el-icon { font-size: 23px; }.diagnostic-privacy h2, .diagnostic-privacy p { margin: 0; }.diagnostic-privacy h2 { font-size: 13px; }.diagnostic-privacy p { margin-top: 4px; color: var(--text-secondary); font-size: 11px; line-height: 1.55; }.about { padding: 15px; }.about h2 { margin: 0 0 5px; font-size: 14px; }.about p { margin: 0; color: var(--text-secondary); font-size: 11px; line-height: 1.55; }.diagnostics-loading { padding: 28px; }
...
@media (min-width: 1200px) {
  .overview { grid-template-columns: auto minmax(180px, .75fr) auto minmax(430px, 1.5fr); padding: 14px 18px; }
  .overview dl { grid-column: 4; margin: 0; padding: 0 0 0 18px; border-top: 0; border-left: 1px solid var(--line-soft); }
  .component-grid { grid-template-columns: repeat(3, minmax(0, 1fr)); }
}
@media (max-width: 767px) { .overview { grid-template-columns: auto 1fr; padding: 17px; }.overview > .el-tag { grid-column: 1 / -1; justify-self: start; }.overview dl { grid-column: 1 / -1; grid-template-columns: 1fr; }.component-grid, .metrics-grid, .diagnostics-footer { grid-template-columns: 1fr; }.component-grid article { grid-template-columns: auto 1fr; }.component-grid article > .el-tag { grid-column: 2; justify-self: start; }.queue-grid { gap: 6px; }.queue-grid div { padding: 10px; } }
</style>
