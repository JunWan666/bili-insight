...
| 页面 | 主要内容 |
| --- | --- |
| 首页/解析页 | BV/AV/ss/ep 链接输入、最近解析、匿名/登录状态、支持范围说明 |
...
- 后端覆盖任务单删/批删、活动任务冲突、产物受管保留、最近解析单删/批删和关联数据冲突。
- 前端覆盖默认折叠、分组展开、任务批量删除、最近解析批量删除及删除后列表刷新。
