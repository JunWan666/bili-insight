...
| Windows 一键入口 | [install.ps1](https://github.com/JunWan666/bili-insight/releases/latest/download/install.ps1) |
...
irm https://github.com/JunWan666/bili-insight/releases/latest/download/deploy.ps1 -OutFile $script
